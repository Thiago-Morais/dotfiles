...
hl.bind(b.combo("CTRL", "Control_L"), hl.plugin.dynamic_cursors.dsp_magnify({ duration = 100, size = 6.0 }), { desc = "Find cursor" })
hl.bind(b.combo("CTRL", "Control_R"), hl.plugin.dynamic_cursors.dsp_magnify({ duration = 100, size = 6.0 }), { desc = "Find cursor" })
